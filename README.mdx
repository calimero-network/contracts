...
This repository contains the smart contracts that power the [Calimero Network](https://github.com/calimero-network/core), with NEAR as the supported blockchain target.

## Project Structure

The repository currently ships NEAR contracts:
